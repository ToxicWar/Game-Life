...
/**
 * Панель симулятора с редактором поля. Левой кнопкой мыши можно ставить клетки,
 * правой - стирать. Редактирование доступно в любое время, даже когда симуляция
 * запущена. Процесс симуляции выполняется в отдельном потоке.
 * @author Anton Larkin
 */
