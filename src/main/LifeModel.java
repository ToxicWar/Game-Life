...
/**
 * Модель данных "Жизни". Поле завернуто в тороид, т.е. и левый и правый края, и
 * верхний и нижний, являются замкнутыми. При симуляции используется принцип
 * двойной буферизации: данные берутся из главного массива mainField, после
 * расчета результат складывается во вспомогательный массив backField. По
 * окончании расчета одного шага ссылки на эти массивы меняются местами. В
 * массивах хранятся значения: 0, если клетка мертва, и 1, если жива.
 * @author Anton Larkin
 */
